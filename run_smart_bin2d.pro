pro run_smart_bin2d, res1tore=res1tore
...
hline,0,color=0
setcolors,/sys
plot,xarr,smooth(total((fluxposimage-fluxnegimage)[*,90:179],2),5)*1d16,ps=10,yran=[-3d23,3d23],thick=5,/xsty,/ysty,ymarg=[5,0],xtit='Years Since 1997',ytit=textoidl('(\Phi_{+}+\Phi_{-})')+' [Mx]'
hline,0,color=0
oplot,xarr,smooth(total((fluxposimage-fluxnegimage)[*,0:89],2),5)*1d16,ps=10,color=!red,thick=5,lines=2
...
!p.multi=[0,1,2]
setcolors,/sys
plot,xarr,smooth(nfluxnet,5),ps=10,thick=5,/xsty,ytit=textoidl('Unipolar (\Phi_{+}+\Phi_{-})')+' [Mx]',ymarg=[2,1],xtickname=strarr(10)+' '
hline,0,color=0
oplot,xarr,smooth(sfluxnet,5),ps=10,color=!red,thick=5,lines=2
plot,xarr,nfluxcumm,ps=10,thick=5,/xsty,yran=[-10d22,20d22],ytit=textoidl('Cummulative Unipolar (\Phi_{+}+\Phi_{-})')+' [Mx]',ymarg=[3,-2],xtit='Years since 1997'
hline,0,color=0
oplot,xarr,sfluxcumm,ps=10,color=!red,thick=5,lines=2
;xyouts,.6,.55,'North: '+textoidl('(\Phi_{+}+\Phi_{-}) = ')+string(total((fluxposimage-fluxnegimage)[*,110:179])*1d16,form='(E9.2)')+' Mx',/norm
;xyouts,.6,.52,'South: '+textoidl('(\Phi_{+}+\Phi_{-}) = ')+string(total((fluxposimage-fluxnegimage)[*,0:69])*1d16,form='(E9.2)')+' Mx',/norm,color=!red
