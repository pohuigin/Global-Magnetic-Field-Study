...
\begin{abstract}
Currently, the most successful model of the magnetic solar cycle is the Babcock-Leighton process, which is able to qualitatively reproduce the large-scale solar magnetic field over time by simulating the surface transport of injected bipolar flux. To better constrain the model, accurate measurements of solar magnetic fields over the solar cycle, such as the statistical properties of active regions (ARs), are required. This work characterises the long-term patterns of AR emergence and evolution that are responsible for the progression of the observed magnetic solar cycle. The SolarMonitor Active Region Tracker (SMART) is used to automatically detect and characterise solar ARs using 15\,years of \emph{SOHO}/MDI line-of-sight magnetograms covering solar cycle 23. The heliographic location, area, magnetic flux, and flux imbalance of ARs are measured and compared to the results of a global magnetic flux assimilation and potential field spherical harmonic decomposition model. We draw several conclusions from this work: 



It is concluded that these observations are consistent with the Babcock-Leighton process and furthermore, allow the properties of the magnetic flux injected into the model as well as the mechanisms that transport the flux to be constrained.
...
Three periods of increased average AR flux and area appear to be mainly responsible for the global polar magnetic field reversal.
